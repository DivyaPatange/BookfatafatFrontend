...
<div class="row mb-3">
    <div class="col-lg-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" id="submitForm" action="{{ route('vendor.service.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="service_price" class="form-control" id="service_price" placeholder="Enter Service Price">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
