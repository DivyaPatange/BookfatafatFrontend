...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <?php
                $payment = DB::table('service_payments')->where('order_id', $order->order_number)->first();
                // dd(!empty($payment));
            ?>
            <div class="body">
                <!-- Nav tabs -->
                <ul class="nav nav-tabs tab-nav-right" role="tablist">
                    <li role="presentation" class="active"><a href="#home" data-toggle="tab">Service Details</a></li>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="home">
                        <blockquote class="m-b-25">
                            <p>Service Number :- {{ $order->order_number }}</p>
                            <?php 
                                $service = DB::table('services')->where('id', $order->service_id)->first();
                            ?>
                            <p>Service Name:- @if(!empty($service)) {{ $service->service_name }} @endif</p>
                            <p>Description:- @if(!empty($service)) {{ $service->description }} @endif</p>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="settings">
                        ...
                        <form method="post" action="{{ route('service-payment', $order->id) }}" id="paymentForm">
                            @csrf
